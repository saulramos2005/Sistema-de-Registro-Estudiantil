...
<html lang="en">
  <head>
	...
	<link rel="stylesheet" href="../ejercicio/css/sidebar.css";>
	<link rel="stylesheet" href="../ejercicio/css/sticky-footer.css";>
	<!-- jQuery library -->
...
<section>
	<div class="container">
		<?php
		require_once('../ejercicio/views/Layouts/sidebar.php');
...
<footer>
	<?php require_once('../ejercicio/views/Layouts/footer.php'); ?>
</footer>
</body>
</html>